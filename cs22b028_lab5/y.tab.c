...
const int YY_parser_CLASS::ID=260;
const int YY_parser_CLASS::INCREMENT=261;
const int YY_parser_CLASS::DECREMENT=262;
const int YY_parser_CLASS::ADD=263;
const int YY_parser_CLASS::SUB=264;
const int YY_parser_CLASS::MUL=265;
const int YY_parser_CLASS::DIV=266;
const int YY_parser_CLASS::MOD=267;
const int YY_parser_CLASS::LP=268;
const int YY_parser_CLASS::RP=269;
const int YY_parser_CLASS::ASSIGN=270;
const int YY_parser_CLASS::SEMICOLON=271;
...
#define YYTRANSLATE(x) ((unsigned)(x) <= 272 ? yytranslate[x] : 23)
...
static const short yyprhs[] = {     0,
     0,     3,     7,    11,    13,    17,    21,    23,    27,    31,
    35,    39,    41,    43,    47,    51,    54,    57,    59,    61
};

static const short yyrhs[] = {    19,
    16,     0,    18,    19,    16,     0,     5,    15,    20,     0,
     1,     0,    20,     8,    21,     0,    20,     9,    21,     0,
    21,     0,    20,     1,    21,     0,    21,    10,    22,     0,
    21,    11,    22,     0,    21,    12,    22,     0,    22,     0,
     1,     0,    13,    20,    14,     0,    13,    20,     1,     0,
     1,    14,     0,     9,    22,     0,     3,     0,     5,     0,
     1,     0
};
...
static const short yyrline[] = { 0,
    55,    57,    60,    72,    78,    83,    87,    90,    97,   102,
   113,   124,   127,   133,   137,   141,   147,   151,   156,   160
};

static const char * const yytname[] = {   "$","error","$illegal.","INT","FLOAT",
"ID","INCREMENT","DECREMENT","ADD","SUB","MUL","DIV","MOD","LP","RP","ASSIGN",
"SEMICOLON","UMINUS","slist","stmt","E","T","F",""
};
#endif
...
static const short yydefact[] = {     0,
     4,     0,     0,     0,     0,     0,     1,    13,    18,    19,
     0,     0,     0,     7,    12,     2,    16,    20,    17,     0,
     0,     0,     0,     0,     0,     0,     0,    14,     8,     5,
     6,     9,    10,    11,     0,     0
};
...
-32768,    -9,    23,     4,    30,     9,-32768,    16,-32768,-32768,
    33,    30,    13,    40,-32768,-32768,-32768,    16,-32768,    18,
    30,    30,    30,    33,    33,    33,    -1,-32768,    40,    40,
    40,-32768,-32768,-32768,    37,-32768
};
...
static const short yytable[] = {     8,
     1,     9,    19,    10,     2,     5,   -15,    11,   -15,   -15,
   -15,    12,   -15,    21,   -15,    32,    33,    34,    27,     7,
    22,    23,    35,     1,    16,    22,    23,     2,    -3,    17,
     8,    28,     9,    18,    10,     9,    36,    10,    11,    20,
     6,    11,    12,     0,     0,    12,    29,    30,    31,    24,
    25,    26,    29
};

static const short yycheck[] = {     1,
     1,     3,    11,     5,     5,    15,     8,     9,    10,    11,
    12,    13,    14,     1,    16,    24,    25,    26,     1,    16,
     8,     9,     0,     1,    16,     8,     9,     5,    16,    14,
     1,    14,     3,     1,     5,     3,     0,     5,     9,    12,
     3,     9,    13,    -1,    -1,    13,    21,    22,    23,    10,
    11,    12,    27
};
...
#line 61 "prob3.y"
{
        if(errorFlag == 0){
            // printf("\t\tAccepted.\n");
            Node *varNode = createNode("variable", NULL, NULL, 0, yyvsp[-2].lexeme);
            printf("\t\t");
            printPostOrder(yyvsp[0].node);
            freeTree(yyvsp[0].node);
            printf("\n");
        }
        errorFlag = 0;
    ;
...
{ 
        // $$ = $1 + $3; 
        yyval.node = createNode("+", yyvsp[-2].node, yyvsp[0].node, 0, NULL);
    ;
    break;}
case 6:
#line 83 "prob3.y"
...
#line 141 "prob3.y"
{
        ...
        errorFlag = 1;
        // $$ = 0;
        yyval.node = createNode("number", NULL, NULL, 0, NULL);
    ;
    break;}
case 17:
#line 147 "prob3.y"
{ 
        // $$ = -$2; 
        yyval.node = createNode("-", yyvsp[0].node, NULL, 0, NULL);
    ;
    break;}
case 18:
#line 151 "prob3.y"
{ 
        // $$ = $1;
        // temp_int = $1; 
        yyval.node = createNode("number", NULL, NULL, yyvsp[0].num, NULL);
    ;
    break;}
case 19:
#line 156 "prob3.y"
{ 
        // $$ = $1;
        yyval.node = createNode("variable", NULL, NULL, 0, strdup(yyvsp[0].lexeme));
    ;
    break;}
case 20:
#line 160 "prob3.y"
